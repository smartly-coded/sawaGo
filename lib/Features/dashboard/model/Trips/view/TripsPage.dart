                          ...
                          child: ListView(
                            ...
                            children: [
                              CategoryItem(
                                title: "جميع الرحلات",
                                icon: "assets/images/Vector (2).png",
                                isSelected: cubit.selectedCategory == "جميع الرحلات",
                                onTap: () => cubit.selectCategory("جميع الرحلات"),
                                isTablet: isTablet,
                              ),
                              CategoryItem(
                                title: "الحافلات",
                                icon: "assets/images/Vector (3).png",
                                isSelected: cubit.selectedCategory == "النافلة",
                                onTap: () => cubit.selectCategory("النافلة"),
                                isTablet: isTablet,
                              ),
                              CategoryItem(
                          ...
                          itemBuilder: (context, index) {
                            if (state is TripsLoaded) {
                              if (index < state.trips.length) {
                                return SizedBox(
                                  width: maxWidth * 0.9,
                                  child: DriverTripCard(trip: state.trips[index]),
                                );
                              } else {
                                return const Padding(
